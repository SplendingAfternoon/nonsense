      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "If the light will not change, change what you wear in it."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
        ...
        for (const entry of entries) {
          if (entry.isIntersecting && !hasRunRef.current) {
            ...
            const id = setInterval(() => {
              ...
              el.textContent = text.slice(0, locked) + Array.from({ length: text.length - locked }, rand).join("");
            }, tickInterval);
          }
        }
      },
...
function FilmGrain() {
  ...
  const offsetRef = reactExports.useRef({ x: 0, y: 0 });
  reactExports.useEffect(() => {
    ...
    const animate = () => {
      offsetRef.current.x = Math.sin(Date.now() * 5e-4) * 2;
      offsetRef.current.y = Math.cos(Date.now() * 7e-4) * 2;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            ...
            style: {
              ...
              height: "auto",
              animation: prefersReduced ? "none" : "sigil-pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite"
            }
          }
        ),
...
const PRODUCTS = [
  ...
  },
  {
    id: "uriel",
    name: "URIEL",
    description: "Angular statement. Built for the room that won’t adjust its lighting.",
...
const ITEMS = [
  {
    ...
    content: "FL-41 is a rose-tinted filter developed originally for photosensitivity management. In our lenses, it attenuates the 480–520nm band — the range most associated with sustained visual fatigue under LED and fluorescent sources. It does not treat any condition. It reduces the intensity of the wavelengths you encounter most in artificially lit rooms."
  },
  {
    title: "VACUUM-DEPOSITED ANTI-GLARE",
    content: "A multi-layer anti-reflective coating is applied under vacuum to eliminate surface reflections and internal lens bounce-back. This removes visual noise without affecting the spectral properties of the FL-41 tint. The result is cleaner, lower-effort vision through the lens."
  },
  {
    title: "GRADE-5 TITANIUM CHASSIS",
    content: "Grade-5 titanium — the same alloy used in aerospace and surgical instruments — offers an exceptional strength-to-weight ratio. The frames weigh approximately 18g. They flex without fatiguing, resist corrosion, and do not deform under normal daily use. There is no planned obsolescence in the material."
  },
  {
    title: "SMALL-BATCH PRODUCTION",
    content: "We produce in small quantities. This is not a marketing position — it is a quality constraint. Fewer units per run means each pair receives individual inspection. We would rather slow the business than ship a frame we would not keep ourselves."
  }
];
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { id: "top", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(EnvironmentSection, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProductSection, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TechnologySection, {}),
